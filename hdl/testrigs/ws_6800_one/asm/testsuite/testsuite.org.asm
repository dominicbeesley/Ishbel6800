...
*
*
*      REQUIRES RAM AT LOCATIONS        'DATA' .. 'DATA'+$200	*
*      REQUIRES ROM OR RAM AT LOCATIONS 'CODE' .. 'CODE'+$2FFF	*
*
...
*
_DATA	EQU	0
*_CODE	EQU	$8000   old/org. stuff
_CODE	EQU	$2000
PDATA  EQU $E07E      PDATA IS SERIAL OUTPUT ROUTINE, CAN PUT BREAKPOINT AFTER HERE
...
STACK   RMB    8
DATA    FCB    $AA,$55,$AA,$00,$00,$FF,$40,$54  * WAS @252,@125,@252,@0,@0,@377,@100,@124
        FCB    $80,$81,$BF,$FE
DATA1   FCB    $7D,$7E,$7F,$01   * WAS @175,@176,@177,@001
TMP     RMB    2
*
...
*
             ...
             BNE    *
             PULA 
             EORA   #$10	* Need to confirm the correct result here... YES $C1 and $10 correct on real CPU!
             BNE    *
*
             LDAA   #$C0
             TAP
